...
<div class="top-bar" id="mainNavigation">
  <div class="top-bar-left">
    <ul class="menu vertical medium-horizontal">
      ...
      <a href="mujer.php"><img id="sombra" src="img/mujer.png" width="40px"></a>
      <a href="hombre.php"><img id="sombra" src="img/hombre.png" width="40px"></a>
...
<div class="orbit" role="region" aria-label="Favorite Space Pictures" data-orbit data-options="animInFromLeft:fade-in; animInFromRight:fade-in; animOutToLeft:fade-out; animOutToRight:fade-out;">
  <ul class="orbit-container">
    ...
    <li class="is-active orbit-slide">
      <img class="orbit-image" src="img/slide3.png" alt="Space">
    </li>
    <li class="orbit-slide">
      <img class="orbit-image" src="img/slide4.png" alt="Space">
    </li>
    <li class="orbit-slide">
      <img class="orbit-image" src="img/slide2.png" alt="Space">
    </li>
    <li class="orbit-slide">
      <img class="orbit-image" src="img/slide1.png" alt="Space">
    </li>
  </ul>
